...
void AlphaCPU::Initialize_SignalsAndSlots()
{
	...
	QObject::connect(floatingpointExecutor.data(), &FloatingPointExecutor::illegalInstruction,
		this, &AlphaCPU::handleIllegalInstruction);

	connect(this, &AlphaCPU::fpcrChanged, floatingpointExecutor, &FloatingPointExecutor::setFPCR);
	...
	QObject::connect(controlExecutor.data(), &ControlExecutor::trapRaised,
		this, &AlphaCPU::raiseTrap);
	QObject::connect(controlExecutor.data(), &ControlExecutor::illegalInstruction,
		this, &AlphaCPU::handleIllegalInstruction);

	// IntegerExecutor → AlphaCPU
	QObject::connect(integerExec.data(), &IntegerExecutor::trapRaised,
	...
	// Memory → AlphaCPU
	QObject::connect(memory, &SafeMemory::memoryWritten,
		this, &AlphaCPU::handleMemoryWrite);
	QObject::connect(memory, &SafeMemory::memoryRead,
		this, &AlphaCPU::handleMemoryRead);

	// Self-signals (for external observation)
	QObject::connect(this, &AlphaCPU::halted,
