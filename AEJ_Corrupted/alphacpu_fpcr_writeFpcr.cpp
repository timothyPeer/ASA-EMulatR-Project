...
// Connect memory signals
    QObject::connect(memory, &SafeMemory::memoryWritten, this, &AlphaCPU::handleMemoryWrite);
    QObject::connect(memory, &SafeMemory::memoryRead, this, &AlphaCPU::handleMemoryRead);

    // Floating point executor
    QObject::connect(fpExecutor, &FloatingPointExecutor::trapRaised, this, &AlphaCPU::handleFpTrapRaised);
    QObject::connect(fpExecutor, &FloatingPointExecutor::illegalInstruction, this, &AlphaCPU::handleIllegalInstruction);

    // Control executor
    QObject::connect(controlExecutor, &ControlExecutor::trapRaised, this, &AlphaCPU::raiseTrap);

    // Integer executor
    QObject::connect(integerExecutor, &IntegerExecutor::trapRaised, this, &AlphaCPU::handleTrapRaised);
    QObject::connect(integerExecutor, &IntegerExecutor::illegalInstruction, this, &AlphaCPU::handleIllegalInstruction);

    // Vector executor
    QObject::connect(vectorExecutor, &VectorExecutor::trapRaised, this, &AlphaCPU::handleTrapRaised);

    // CPU-internal signals
    QObject::connect(this, &AlphaCPU::halted, this, &AlphaCPU::handleHalt);
    QObject::connect(this, &AlphaCPU::resetRequested, this, &AlphaCPU::handleReset);
}
