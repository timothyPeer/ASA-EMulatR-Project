...
public:
    ...
    InstructionDefinition(const QString& mnemonic, quint32 opcode, qint32 functionCode = -1,
        InstructionFormat format = InstructionFormat::FORMAT_OPERATE, Section section = Section::SECTION_OTHER,
    ...
    // Format to string
    QString formatToString(InstructionFormat fmt) const {
        switch (fmt) {
        case InstructionFormat::FORMAT_OPERATE: return "Operate";
        case InstructionFormat::FORMAT_BRANCH: return "Branch";
        case InstructionFormat::FORMAT_MEMORY: return "Memory";
        case InstructionFormat::FORMAT_SYSTEM: return "System";
        case InstructionFormat::FORMAT_VECTOR: return "Vector";
        case InstructionFormat::FORMAT_MEMORY_BARRIER: return "MemoryBarrier";
	...
	InstructionFormat format = InstructionFormat::FORMAT_OPERATE;
