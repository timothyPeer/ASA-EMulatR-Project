...
void AlphaJITSystem::InitializeSystem(RegisterBank* registerBank_, FpRegisterBankcls* fpRegisterBankCls_, SafeMemory* safeMemory_)
{
	registerBank = registerBank_; fpRegisterBankcls = fpRegisterBankCls_; safeMemory = safeMemory_;
	// Initialize the execution engine
	engine = new AlphaJITExecutionEngine(registerBank_,fpRegisterBankCls_,safeMemory_);
