...
["./about-mmu-and-tlb.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; About MMU and TLB — Definitions &#38; Roles","MMU — Memory Management Unit ----------------------------------------------------------------------------- The **Memory Management Unit (MMU)** is...",""],
["./addresstranslation.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Address Translation (va &#60;-&#62; pa)","Virtual-to-Physical Address Translation in Alpha Architecture",""],
["./alpha-registers.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design)","The objective of this documentation is to provide a \"single source of truth\" with respect to Alpha, Tru64, Unix, VAX registers and their...",""],
...
["./alphainstructioncache.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; AlphaInstructionCache","UnifiedDataCache  AlphaCPU   ↓ PC → UnifiedDataCache::read()       → hit? return       → miss → fallback →...",""],
...
["./appendix.html","Appendix","Sections Alpha System Architecture Format Reference Class Dictionary Devices Firmware (SRM EV59) - ES40 Glossary Logging Registers (Alpha) Signals...",""],
["./architecture-guide-exceptions-interrupts-machinechecks.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Architecture-Guide","1. Exception Types &#38; Classification  Synchronous (Exceptions): Caused directly by the current instruction (e.g., arithmetic overflow, acc...",""],
["./architecture-registers-claude.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Architecture Registers","Reference:  Frame Pointer Process Status Register-PSR ASA-EMulatR Initialization Registers (Alpha)",""],
["./architecture.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture","The ASA architecture comprises, or will comprise of the following architecture systems. ",""],
...
["./asa-emulator-implementation.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Machine Check Handling and Machine Check Frame &#62; ASA Emulator Implementation","The machine check frame is implemented using the  HWStackFrame structure (HWFrameStack.h). This struct captures all relevant architectural st...",""],
["./asa-emulator-initialization.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; ASA Emulator Initialization","Step Action 1 SystemLoader loads system parameters from JSON config 2 Calls AlphaSMPManager::configureSystem(cpuCount, memoryMB, startPC) 3 AlphaS...",""],
...
["./build-and-integration.html","Introduction &#62; Build and Integration","Enter topic text here.",""],
["./bus-virtualhardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model &#62; Bus","Enter topic text here.",""],
["./businterface-classdictionary.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Logical Hardware Model &#62; BusInterface","Is an abstract interface for any device or bus that needs to participate in:",""],
["./cabinet-virtualhardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model &#62; Cabinet","Enter topic text here.",""],
...
["./caching---instruction.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching","The cache hierarchy can dramatically improve performance by reducing memory access latency. ",""],
["./caching-code.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; Caching-Code","/* ALPHA AXP CACHE ARCHITECTURE ANALYSIS =====================================  ACTUAL ALPHA CACHE HIERARCHY: CPU Pipeline: ├── L1 I-Cache (I...",""],
["./canonical-register-definitions-alphaaxpregister.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Registers Defined — Canonical Register and Bitfield Enumeration","This section documents the full set of architectural and internal registers implemented in the ASA-EMulatR, including all standard Alpha AXP integ...",""],
["./canonical-trap-handling.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Trap Handling","This page documents the three canonical patterns for delivering floating-point exceptions and traps in the ASA-EMulatR, as required by the Alpha A...",""],
...
["./class-dictionary-claude.html","Appendix &#62; Class Dictionary","Placeholder - and updated classes",""],
...
["./code-3.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; Code-3","// ========== TLB + CACHE INTERACTION DIAGRAM ==========",""],
...
["./configuration-claude.html","Introduction &#62; System Configuration &#62; Configuration Template","Configuration Template Navigation: Introduction System Configuration Configuration Template ",""],
...
["./configuration_loadfile.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; SCSI Device Integration &#62; Configuration_loadFile TODO","// SCSI Configuration System #pragma once  #include &#60;QSettings&#62; #include &#60;QJsonDocument&#62; #include &#60;QJsonObject&#62; #include &#38;l...",""],
...
["./coverage-tlbsystem.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Coverage","Function Name CPU Physical Addr (PA) Virtual Addr (VA) ASN IsPending PTE I-TLB D-TLB Range/Size Notes / Description invalidateAllTLBs_PTE X  ...",""],
...
["./datatype-considerations.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; DataType Considerations","The ASA-EMulatR uses specialized floating-point classes to accurately represent all Alpha/VAX floating-point formats and provide safe conversions ...",""],
...
["./device-assignments.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Device Assignments","For Device: dqa0.0.0.15.0 (IDE disk, PCI bus 15, function 0):",""],
["./devicemanager-classdictionary.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Logical Hardware Model &#62; DeviceManager","Is a global registry, factory, and orchestrator for all devices (not just physical, but logical too: virtual devices, pseudo-devices, buses, bridg...",""],
["./devices--interfaces.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces","Enter topic text here.",""],
["./devices-claude.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices","The application stack will support this hierarchical device structure. ",""],
["./drawer-virtualdevices.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model &#62; Drawer","Enter topic text here.",""],
...
["./emulated-hardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized","Device Family Description Tulip DC21040   Q-Logic",""],
...
["./exception-source-bitmask-maski.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Exception Source Bitmask Masking","This covers all typical unary, binary, and ternary (FMA, etc.) grains used in Alpha AXP floating-point, following architectural conventions.",""],
["./exceptions-alphacpu.html","Appendix &#62; Class Dictionary &#62; AlphaCPU &#62; Exceptions","See Also.  OptimizedExceptionStatusRegister",""],
["./exceptionsinterruptsandmachinechecks.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks","The ASA-EMulatR implements a full architectural model for exceptions, interrupts, and machine checks, faithfully mirroring the Alpha AXP and VAX h...",""],
...
["./execution-stack-breakdown-for-.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Instruction Grain Data Flow — Overview &#62; Grain Execution - Store Instruction","This section documents the control and data flow for store instruction grains (such as STT_InstructionGrain::execute()) in the Alpha AXP emulator.",""],
["./fca-2354-systembus.html","Appendix &#62; Class Dictionary &#62; SystemBus &#62; FCA-2354","Enter topic text here.",""],
["./firmware-(srm-ev59)---es40.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Firmware (SRM EV59) - ES40","Device Current Revision Filename Update Revision Abios v5.71 abios_fw v5.71 SRM v6.8-xx srm67_fw v6.8-xx pga0 DS3.82A1 kgpsa_8k_fw DS3.91A1 pgb0 S...",""],
["./firmware-.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Firmware (SRM EV59) - ES40 &#62; Firmware: ","Required Files for the Alpha Emulator (ASA) Here’s how the files you found break down and what the ES40-class emulator actually needs.  File ...",""],
["./floating-point-control-registe.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Floating-Point Control Register (FPCR)","The Floating Point Control Register (FPCR)  is a central architectural register on Alpha AXP systems, controlling all floating-point exceptio...",""],
["./fpcrregister-classdictionary.html","Appendix &#62; Class Dictionary &#62; FpcrRegister","Enter topic text here.",""],
["./frame-pointer-claude.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Architecture Registers &#62; Frame Pointer","Project References:  AlphaCPU::stackFrame::framePointer  Usage:   Holds the base address of the current stack frame (in function/pr...",""],
...
["./grain-default-behavior.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Alpha AXP Instruction Qualifier Suffixes &#62; Grain Default Behavior","When no qualifier is specified on an Alpha floating-point instruction, the default behavior is:",""],
["./grain-exception-fixups.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Alpha AXP Instruction Qualifier Suffixes &#62; Grain Exception Fixups","The Alpha architecture supports both hardware and software fixups, but they work in different ways:",""],
["./grain-qualifiers---saturate.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Alpha AXP Instruction Qualifier Suffixes &#62; Grain Qualifiers - Saturate","This page documents the trap models and exception checking logic for all floating-point arithmetic instructions in the ASA-EMulatR. The Alpha arch...",""],
...
["./index(0).html","ASA-Architectural Guide ","Resources Online help made easy Multi-Channel Publishing Teamwork Features Power features Templates + Skins H+M Premium Pack Screenshots New in H+...",""],
...
["./instruction-grain.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains","The AlphaInstructionGrain is the fundamental building block of the ASA-EMulatR’s instruction execution model. It provides a lightweight, stateless...",""],
["./instruction-memory-barriers.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Memory Barrier Instructions — Overview and Integration","This section documents the Alpha AXP memory barrier instructions and their correct integration in the emulator’s execution core. Memory barrier in...",""],
["./instruction-stack-exection.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Instruction Grain Data Flow — Overview &#62; Grain Execution - Load Instruction","This section describes the complete data and control flow for a memory access instruction grain (such as LDT_InstructionGrain::execute()) in the A...",""],
["./instruction-tlb-pagetable.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Page Table Support &#62; Invalidation  &#62; Instruction TLB","Instruction TLB Navigation: Introduction Platform Architectures Alpha Architecture Virtual Address Space — Overview Memory Management Page Table S...",""],
["./instructions-introduction.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Instruction Grain Data Flow — Overview","Instruction grains are the fundamental execution units in the ASA-EMulatR, providing a modular, stateless, and architecture-faithful implementatio...",""],
...
["./interrupt-levels---vax.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; VAX Architecture — Exceptions, Interrupts, and Machine Checks &#62;   VAX Interrupt Priority Level (IPL) — Introduction","The VAX Interrupt Priority Level (IPL) is a 6-bit field (values 0–63) that plays a central role in both hardware and software interrupt arbitratio...",""],
["./interrupt-levels-.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Alpha AXP Interrupt Priority Level (IPL) — Introduction","The Interrupt Priority Level (IPL) field on Alpha AXP systems is a 5-bit architectural value (bits 7:3 in the Processor Status register) that dete...",""],
["./interrupts-exceptions-faults-machinechecks.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts","Alpha AXP interrupt classes by type and their assigned IPLs (Interrupt Priority Levels). The official IPL values are mostly in the range 1–31, but...",""],
["./introduction.html","Introduction","About this Effort  This project has been on my wish-list to accomplish for more than 20 years. During that time, I was fully engaged in earni...",""],
["./invalidation-pagetable.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Page Table Support &#62; Invalidation ","Functions CPU PA VA ASN IsPending PTE I-TLB D-TLB Range Size in page invalidateAllTLBs_PTE invalidateAllTLBs_PTE x     x    in...",""],
["./iodrawer-virtualdevices.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model &#62; IODrawer","Enter topic text here.",""],
["./iohose-virtualhardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model &#62; IOHose","Enter topic text here.",""],
["./ipi-stack-documentation.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Symmetric Multi-Processing &#62; Interprocessor Interrupt (IPI) Stack Design","�� Alpha Emulator — Interprocessor Interrupt (IPI) Stack Design",""],
["./iprbank-classdictionary.html","Appendix &#62; Class Dictionary &#62; IprBank","Enter topic text here.",""],
["./iprbank-registers.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Symmetric Multi-Processing &#62; Internal Processor Register (IPR) Bank","Alpha Emulator — Internal Processor Register (IPR) Bank Documentation",""],
...
["./jit-.html","Introduction &#62; Architecture &#62; Virtual Address Space — Overview &#62; JIT","Future Implementation:  ASA-Assembler library   Requires a dedicated assembler library dedicated for the host processor family (Intel , ...",""],
...
["./l1cache.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; L1 I-Cache","L1 I-Cache: 32KB, 64-byte lines, 2-way associative (simplified as direct-mapped here)",""],
["./l2cache.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; L2 D-Cache","// L2 Unified Cache: 1MB, 64-byte lines Serves as the backing-cache-store for Execute unit operations.   EXECUTE CHARACTERISTICS:   &#38;nbs...",""],
["./l3-shared-(smp)-unifiedcache.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; L3 Shared (SMP) UnifiedCache","Enter topic text here.",""],
...
["./linux-on-alpha-specific.html","Introduction &#62; Platform Architectures &#62; LINUX on Alpha","Linux was ported to Alpha beginning in the 1990s and provides a more mainstream, open-source workload for Alpha hardware. It supports a wide range...",""],
["./logical-hardware-model.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Logical Hardware Model","Logical Model (BusInterface/DeviceManager)  All devices that require MMIO, configuration, system-level query, or interrupt support should imp...",""],
["./machine-check---hardware-error.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Machine Check Handling and Machine Check Frame","A machine check is a critical processor exception raised for fatal hardware errors such as double ECC memory errors, uncorrectable bus faults, or ...",""],
["./machine_hardware-fault-level.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Machine/Hardware Fault Level - Partial Support","Includes machine checks, hardware interrupts, and uncorrectable errors.",""],
...
["./markup-configuration.html","Introduction &#62; System Configuration &#62; Markup ","Markup Navigation: Introduction System Configuration Markup ",""],
...
["./memory-management.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management","===============================================================================",""],
...
["./m_psr-claude.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Architecture Registers &#62; Process Status Register-PSR","Project References:  AlphaCPU::m_psr  m_psr Processor Status Register Internal CPU state Mode, MMU, FP flags, IPL, AST     Bit...",""],
["./overview-exceptionsinterruptsmachinechecks.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Overview","This section describes the unified exception handling model in the ASA-EMulatR. All exceptions—arithmetic, floating-point, privilege, memory, and ...",""],
...
["./page-table-entries.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Page Table Support &#62; Invalidation  &#62; Page Table Entries","Considerations:  SMP Implementations partition the TLB by CPU id - the processor identification number.   Function TLB Entry Type Argume...",""],
["./page-table-support.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Page Table Support","Page Table Interface Documentation for Alpha Emulator",""],
...
["./pcidevice-virtualhardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model &#62; PCIDevice","Enter topic text here.",""],
...
["./platform-architecture-endianes.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Platform Architecture-Endianess","Alpha processors are little-endian by default. The Alpha AXP architecture specification defines little-endian as the native byte ordering, though ...",""],
...
["./processor-status-register-(ps).html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Processor Status Register (PS) — Overview","The Processor Status Register (PS) is a central architectural register on Alpha AXP systems, controlling processor mode, interrupt priority, float...",""],
["./q-logic-emulatedhardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Q-Logic","1. QLogic families that ship in Alpha platforms (1995 – 2003)",""],
["./qualifiers-instruction.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Instruction Grains &#62; Alpha AXP Instruction Qualifier Suffixes","Qualifier Meaning: Typical Usage: /M – Masked Exception All exceptions are masked.Status flags (overflow, underflow, inexact, invalid, reserved op...",""],
...
["./safememory-claude.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; SafeMemory - TODO","Alpha/VAX Floating-Point Exception Handling: Status and Trap Model Reference",""],
...
["./scsi-device-integration.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; SCSI Device Integration","Key Design Principles for SCSI Device Emulation 1. Hierarchical Architecture  Base SCSIDevice class - Handles common SCSI commands (INQUIRY, ...",""],
["./second-topic.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Interfaces","Interfaces Purpose AlphaSMPManager → AlphaCPU Creates, initializes, manages CPUs AlphaCPU → AlphaMemorySystem Fetch/store instructions and data Al...",""],
...
["./stack---level-2-(3_4)-support-.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Tulip DC21040 &#62; Stack - Level 2 (3/4) Support ","TulipNIC implements only the L2/MAC and PHY (via MMIO CSRs, DMA, MII).",""],
["./stack-cpu-interface.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Tulip DC21040 &#62; Stack CPU Interface","┌─────────────┐                ┌───────────────────────┐",""],
...
["./symmetric-multi-processing.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Symmetric Multi-Processing","OVERVIEW  Symmetric Multi-Processing (SMP) is the architectural model where multiple processors share a single, coherent memory and I/O space...",""],
...
["./threadsafety-locksafety.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; SCSI Device Integration &#62; ThreadSafety-LockSafety","The SCSI implementation I showed has several threading considerations and limitations that need to be addressed for proper QThread support:",""],
...
["./todo.html","Introduction &#62; TODO","Enter topic text here.",""],
...
["./translation-lookaside-buffer-(.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Caching &#62; Translation Lookaside Buffer (TLB)","A Translation Lookaside Buffer (TLB) is a small, fast hardware cache that holds a subset of the processor’s page‐table entries—i.e. recently used ...",""],
["./trap-handling-alphacpu.html","Appendix &#62; Class Dictionary &#62; AlphaCPU &#62; Trap Handling","Enter topic text here.",""],
["./trapping-exceptions.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Exception Source Bitmask","Purpose and Implementation in Alpha AXP Emulation  Overview  The Alpha AXP architecture, like many RISC designs, can trigger floating-po...",""],
["./tru64-unix-on-alpha-specific.html","Introduction &#62; Platform Architectures &#62; Tru64 Unix on Alpha","Tru64 UNIX (formerly Digital UNIX) is a 64-bit UNIX operating system specifically tuned for Alpha platforms. It leverages Alpha SMP, memory manage...",""],
["./tulip-dc21040.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Tulip DC21040","1 QLogic families that ship in Alpha platforms (1995 – 2003)",""],
...
["./vax---specific.html","Introduction &#62; Platform Architectures &#62; VAX - Specific","The VAX architecture predates Alpha and defines a 32-bit CISC platform with significant differences from the Alpha AXP RISC design. The ASA-Emulat...",""],
["./vax-architecture.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; VAX Architecture — Exceptions, Interrupts, and Machine Checks","This section provides an overview of the VAX exception and interrupt handling model, as well as the architecture’s approach to machine checks and ...",""],
["./vaxmacroandheader.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros","Enter topic text here.",""],
["./vax_g_to_f_float.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros &#62; VAX_G_TO_F_FLOAT - Converts a 64-bit VAX G_floating value to a 64-bit VAX D_floating","Converts a 64-bit VAX G_floating value to a 32-bit VAX F_floating value.",""],
["./vax_g_to_f_float_2.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros &#62; VAX_D_TO_G_FLOAT - Convert VAX D_Float to 64-bit VAX G_Float","Converts a 64-bit VAX D_floating value to a 64-bit VAX G_floating value.",""],
["./vax_g_to_f_float_3.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros &#62; VAX_LWORD_TO_QWORD","Enter topic text here.",""],
["./vax_g_to_f_float_4.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros &#62; VAX_LONG_TO_QWORD","/*  * Macro: VAX_LONG_TO_QWORD  * Converts 32-bit signed longword to 64-bit quadword integer.  * Pure sign-extension.  */",""],
["./vax_g_to_qword---convert-vax-g.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros &#62; VAX_G_TO_QWORD - Convert VAX G_Float to 64-bit signed integer","Convert VAX G_Float to 64-bit signed integer (QUADWORD).",""],
["./vax_qword_to_g_float.html","Introduction &#62; Platform Architectures &#62; VAX - Specific &#62; Conversion Macros &#62; VAX_QWORD_TO_G_FLOAT","Enter topic text here.",""],
["./virtual-barrier-support.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Virtual Barrier Support","These are defined by virtual address ranges, influenced by mode bits, MMU settings, and page table base register contents.",""],
["./virtual-hardware.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Hardware - Virtualized &#62; Devices &#38; Interfaces &#62; Physical Hardware Model","Physical Model (QObject tree)  Cabinet, Drawer, IODrawer, IOHose, Bus, PCIDevice, etc. Model the physical and logical topology. May or may no...",""],
["./virtual-to-physical-address-tr.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview &#62; Memory Management &#62; Virtual to Physical Address Translation","Topic Purpose Implementation Needed 1. Virtual Address Mapping Table Map Virtual Address (VA) ranges → Physical Address (PA) ✅ memoryMap or upgrad...",""],
["./virtualization-address-space.html","Introduction &#62; Platform Architectures &#62; Alpha Architecture &#62; Virtual Address Space — Overview","This section introduces the virtual address space model as implemented in the ASA-EMulatR, documenting how virtual memory, address translation, an...",""],
