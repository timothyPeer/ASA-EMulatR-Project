...
["./a-comparative-guide-of-asa-emu.html","Appendix &#62; A Virtual-Physical Hardware Guide of ASA EmulatR to Windows/Linux ","Comparative Guide: Alpha (ASA EmulatR) vs. Windows &#38; Linux Bus Models",""],
...
["./alphacpu-launch-and-handling.html","Appendix &#62; Class Dictionary &#62; AlphaSMPManager &#62; AlphaCPU Launch and Handling","Enter topic text here.",""],
...
["./asn---address-space-number.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; ASN - Address Space Number","Enter topic text here.",""],
["./ast---asynchronous-system-trap-register.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; AST - Asynchronous System Trap","An AST is a software-triggered interrupt delivered at a safe point in process execution, often used for signal delivery, software preemption, or d...",""],
["./asten---asynchronous-syste.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; ASTEN - Asynchronous System Trap / Enable","ASTEN is a processor register (synthetic, not hardware) that controls whether AST delivery is enabled for each of the 4 processor modes:",""],
["./astsr---asynchronous-trap-stat.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; ASTSR - Asynchronous Trap Status Register","ASTSR Helper Functions and Constants (Alpha AXP-EMulatR)",""],
...
["./cache-section-asa-emulatr.html","Introduction &#62; System Configuration &#62; Cache-Section","ASA Emulator Configuration Guide — [CACHE/l1], [CACHE/L2], [CACHE/L3]",""],
...
["./case-example-architecture-awar.html","Case Example Architecture Aware","regarding Alpha System Architecture platform development, I wish to design an emulation application which is capable of booting to the following s...",""],
["./cc-_-pme-cache-control-_-perfo.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; CC / PME Cache Control / Performance Monitoring Enable","Controls cache features, enables/disables performance monitoring counters, and exposes cache diagnostic features.",""],
...
["./configuration-structure-asa-emulatr.html","Introduction &#62; System Configuration &#62; Configuration Structure","The configuration file (`ASAEmulatr.ini`) is organized as Windows/Qt-style INI sections and key-value pairs. Each section describes a major subsys...",""],
...
["./constant-expressions-tableofdefinitions.html","Appendix &#62; Table of Definitons &#62; Constant-Expressions","Considerations. Constants should contain a prefix denoting the region, register, type associated with the constant.   Constant Description SU...",""],
["./context-frame-support.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Context frame Support","HWStackFrame - Lightweight hardware interrupt frame:",""],
...
["./conversion-function---catalog.html","Appendix &#62; Conversion Helper Functions &#62; Conversion Function - Catalog","Function catalog (as defined and requested for OptimizedExceptionStatusRegister.h)",""],
["./conversion-function---header-s.html","Appendix &#62; Conversion Helper Functions &#62; Conversion Function - Header Snippet","Header-only reference snippet (.H only, ASCII, with inline documentation)",""],
["./conversion-function---resultbu.html","Appendix &#62; Conversion Helper Functions &#62; Conversion Function - ResultBundles","Result bundle returned by all conversion checkers  Each helper returns a small &#8220;conversion result&#8221; structure providing the converted value (i...",""],
["./conversion-helper-functions.html","Appendix &#62; Conversion Helper Functions","Scope and goals  This chapter standardizes how conversions set IEEE/VAX floating-point exception semantics, feed the emulator’s status/trap m...",""],
...
["./cpu-section-asa-emulatr.html","Introduction &#62; System Configuration &#62; CPU Section","ASA Emulator Configuration Guide — [CPU] Section   Overview  The [CPU] section defines the number of Alpha CPU cores (processors) to be ...",""],
...
["./dadfx---register.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; DADFX- Data Access Fault Extension Register","The DADFX register (Data Access Fault Extension Register) is a synthetic processor register used by PALcode and the operating system on Alpha AXP ...",""],
...
["./dc_test_ctl---data-cache-test-.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; DC_TEST_CTL - Data Cache Test Control Register","DC_TEST_CTL (Data Cache Test Control Register) is present on EV6/EV67/EV7+ (and later GS/GS1280 platforms). It is not required for basic OpenVMS/T...",""],
...
["./device-section-asa-emulatr.html","Introduction &#62; System Configuration &#62; Device Section","ASA Emulator Configuration Guide — [Device.*] Sections",""],
...
["./exception-and-trap-handling.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Exception and Trap Handling","Overview This document outlines the detailed architecture and implementation steps for exception and trap handling in the Alpha Architecture emula...",""],
...
["./exceptionvectortable-classdictionary.html","Appendix &#62; Class Dictionary &#62; ExceptionVectorTable","Enter topic text here.  void checkPendingInterrupts() {  if (!iprBank() &#124;&#124; !interruptController()-&#62;HasPendingInterrupts()) return; &#38;n...",""],
...
["./fault-vector-handling.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Fault Vector ","DADFX must be handled here.",""],
["./faults---processor-reset.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Faults - Processor Reset","Vector Name Action RESTART_VECTOR IsKernel or PAL Mode",""],
["./fca-2354-systembus.html","Appendix &#62; Class Dictionary &#62; SystemBus &#62; FCA-2354","Enter topic text here.",""],
["./fen---floating-point-enable.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; FEN - Floating-Point Enable","PALcode, OS, and user code can read and write FEN to enable/disable access to floating-point instructions (typically for context switch or lazy FP).",""],
...
["./fparithmetic-module-overview.html","Appendix &#62; FPArithmetic Module Overview","FPArithmetic provides all high-performance, architecture-faithful floating-point arithmetic, conversion, and rounding routines for Alpha AXP emula...",""],
["./fpcr---32-bit-.html","Introduction &#62; Platform Architectures &#62; VAX on ASA-EmulatR &#62; FPCR - 32-Bit ","TheFpcrRegister packs all trap, status, rounding, and condition code bits into the lower 32 bits for compatibility and performance.",""],
...
["./grainresolver-classdictionary.html","Appendix &#62; Class Dictionary &#62; GrainResolver","The `GrainResolver` is the **instruction dispatch registry and lookup engine**  in the ASA-EMulatR.  ",""],
...
["./iccsr---instruction-cache-cont.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; ICCSR - Instruction Cache Control Status Register","Location: Present on most EV6/EV67/EV68/EV7+; not on original 21064/21164.",""],
...
["./implementation-patterns-appendix.html","Appendix &#62; Implementation Patterns","Enter topic text here.",""],
...
["./integration-helpers-conversionfunctions.html","Appendix &#62; Conversion Helper Functions &#62; Integration Helpers","Integrating helpers in instruction grains  Pattern for FP-&#62;INT (e.g., CVTTQ_SUI* variants):  Decode operands and FPCR. Call the appro...",""],
...
["./internal-processor-register-architecture.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register","The following registers are maintained and controlled by the IprBank class:",""],
["./interrupt-hander---best-practi.html","Appendix &#62; Interrupt Hander - Best Practices ","Overview:  Correct interrupt handling is crucial to SMP, device, PALcode, and OS stability. This guide captures best practices for structurin...",""],
...
["./interrupt-life-cycle.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts &#62; Configuration and Setup &#62; Interrupt Life-Cycle","The ASA-EmulatR processes interrupts using the following general flow:",""],
["./interrupt-request-level-pattern.html","Appendix &#62; Implementation Patterns &#62; IE - Interrupt-Request Level","The supported interface pattern is implemented as follows: ",""],
["./interrupt-request.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts &#62; Configuration and Setup &#62; Interrupt Delivery and Processing","Interrupts are processed via PAL instruction grains, via hardware timers, SMP coordinated events, and via an IRQ controller.   For the most p...",""],
["./interrupts---configuration-and.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts &#62; Configuration and Setup","Interrupt handling is distributed between several classes:",""],
["./interrupts-exceptions-faults-machinechecks.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts","The Alpha AXP architecture provides a sophisticated and highly flexible interrupt subsystem designed for high performance, SMP scalability, and ar...",""],
["./interruptsenabled-registerusage.html","Appendix &#62; Implementation Patterns &#62; IRQL - Interrupt Request Level","Interrupt Request Level (IRQL) — Supported Interface Pattern (Alpha AXP PS Register)",""],
["./interval-timers.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interval Timers","The Alpha Interval Timer is a hardware countdown timer that generates periodic interrupts at IPL 22. It&#39;s distinct from the system clock and requi...",""],
["./introduction-asa-emulatr-configuration.html","Introduction &#62; System Configuration &#62; Introduction","The ASA Emulator relies on a structured configuration file (`ASAEmulatr.ini`) to define its virtual system environment, including memory, CPU coun...",""],
...
["./ipl---interrupt-priority-regis-fieldpattern.html","Appendix &#62; Implementation Patterns &#62; IPL - Interrupt Priority Register","Interrupt Priority Level (IPL) Field Pattern (Alpha AXP Processor Status Register)",""],
["./iplstatemanager.html","Appendix &#62; Class Dictionary &#62; IPLStateManager","Is a helper class responsible for tracking and manipulating the current Interrupt Priority Level (IPL) of a processor, managing nested IPL changes...",""],
["./iprbank-classdictionary.html","Appendix &#62; Class Dictionary &#62; IprBank","&#124; Register Name               &#124; Access &#124; Arch Required &#124; Status       &#124; Notes / Gaps / Action &#38;n...",""],
...
["./irq-interrupt-fabric.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts &#62; Configuration and Setup &#62; IRQ Interrupt Fabric","The ASA-EmulatR implements Interrupt/IRQ fabric as illustrated below: ",""],
["./irqcontroller.html","Appendix &#62; Class Dictionary &#62; IRQController","Enter topic text here.",""],
["./isp10x0-systembus.html","Appendix &#62; Class Dictionary &#62; SystemBus &#62; ISP10X0","Enter topic text here.",""],
["./ivt---integer-overflow-trap-pattern.html","Appendix &#62; Implementation Patterns &#62; IVT - Integer Overflow Trap ","The IV bit enables or disables trapping on integer overflow for certain instructions (such as SUBL/V, ADDQ/V, etc.).  These accessors are use...",""],
...
["./key-implementation-functions--.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts &#62; Configuration and Setup &#62; Key Implementation Functions - Ref","Checking and Delivering Interrupts:  bool AlphaCPU::checkAndDispatchInterrupt(); void AlphaCPU::checkInterruptDelivery(); void AlphaCPU::deli...",""],
...
["./mmcsr-(memory-management-contr.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; MMCSR (Memory Management Control/Status Register","MMCSR (Memory Management Control/Status Register) is present on EV6/EV67/EV7+ and later Alpha platforms. It&#39;s required for full PALcode, SRM, Open...",""],
["./mmio-device-interrupts.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Exceptions, Faults, Interrupts, and MachineChecks &#62; Interrupts &#62; Configuration and Setup &#62; MMIO Device Interrupts","Qt Signal/Slot (Decoupled, Flexible)  AlphaSMPManager owns the main QTimer (\"system tick\"). On each tick, AlphaSMPManager emits a s...",""],
...
["./nan-and-reserved-operand-conve.html","Appendix &#62; Conversion Helper Functions &#62; Nan and Reserved Operand Conventions","IEEE quiet NaN is preferred for all conversions that fabricate a NaN (G-&#62;IEEE on reserved operand, or other invalid transformations). Preserve ...",""],
...
["./pal-routines.html","Appendix &#62; PAL Routines","PAL Routines Navigation: Appendix PAL Routines ",""],
...
["./palcode-integration.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; PALcode Integration","For PAL Mode, Implements SavedContext PAL mode needs to preserve complete processor state, not just basic interrupt state.   SavedContext for...",""],
["./panic_entry-registry.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; PANIC_ENTRY Registry","PANIC_ENTRY (Panic Exception Class Kernel Handler Address)",""],
...
["./processor-status-namespaceversion.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Processor Status (Hardware Register)","The following registers are maintained and controlled by the IprBank class:",""],
...
["./property-and-setting-reference.html","Introduction &#62; System Configuration &#62; Property and Setting Reference","ASA EmulatR properties are configured using the following settings as a guide. ",""],
["./psr---process-status-register-pattern.html","Appendix &#62; Implementation Patterns &#62; PSR - Process Status Register (User Mode)","The Processor Status Register (PSR) in user mode on Alpha AXP systems is a software-visible status/control word. It is distinct from the privilege...",""],
["./ptbr-(interrupt-vector-page-ta.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; PTBR (Interrupt Vector Page Table Base Register)","Holds the base physical address of the Interrupt Vector Page Table. Used by PALcode and OS to manage the page table for interrupt vectors, especia...",""],
...
["./register-namespaces.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Register Namespaces","The Alpha PS Register  namespace AlphaPS { constexpr quint64 IRQL_MASK = 0x00000000000000F8ULL; // bits 7:3 constexpr int     IRQL_...",""],
...
["./restartable-atomic-instruction.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Instruction Grains &#62; Restartable Atomic Instruction-Operations","PALcode needs to save context during exception handling, but higher-priority exceptions can still arrive (e.g., machine check while handling page ...",""],
["./restart_vector-register.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; RESTART_VECTOR Register","Holds the address to which execution resumes after certain exceptions, faults, or PALcode-handled events (e.g., hardware interrupts, faults, or ex...",""],
["./rom-section-asa-emulatr.html","Introduction &#62; System Configuration &#62; ROM Section","ASA Emulator Configuration Guide — [Rom] Section   Overview  The [Rom] section defines all ROM (Read-Only Memory) and firmware image pat...",""],
["./rounding-notes---conversion-fu.html","Appendix &#62; Conversion Helper Functions &#62; Rounding Notes - Conversion Functions","Unless the instruction encoding specifies a fixed rounding (e.g., CVTTQ truncates toward zero), read the current FPCR rounding mode and pass it to...",""],
...
["./sse4-intrinsic-integration.html","Appendix &#62; SSE4 Intrinsic Considerations","The FPArithmetic module provides a high-performance, architecture-faithful implementation of Alpha AXP floating-point arithmetic, conversion, and ...",""],
["./sse4-optimizations.html","Introduction &#62; Platform Architectures &#62; SSE4.1 Floating-Point Optimization Reference","This document provides a reference for using SSE4.1 intrinsics to optimize floating-point arithmetic in the Alpha AXP CPU emulator. SSE4.1 (Stream...",""],
["./sse4-rounding-modes.html","Introduction &#62; Platform Architectures &#62; SSE4.1 Floating-Point Optimization Reference &#62; SSE4-Rounding Modes","FpRoundingMode and SSE4.1: Technical Documentation",""],
...
["./syscall_entry-register.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; SYSCALL_ENTRY","TODO",""],
...
["./system-section-asaemulatr.html","Introduction &#62; System Configuration &#62; System Section","The [System] section in the ASAEmulatr.ini configuration file defines the virtual hardware board and system-level characteristics for the Alpha em...",""],
...
["./tableofoperationscvt.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Instruction Grains &#62; Alpha AXP Instruction Qualifier Suffixes &#62; Table of Operations (CVT)","Alpha AXP FP Convert Instruction Grains — conversion map (tabs between columns).",""],
...
["./threads-section-asa-emulatr.html","Introduction &#62; System Configuration &#62; Threads Section","ASA Emulator Configuration Guide — [Threads] Section",""],
...
["./tools--references.html","Appendix &#62; Tools &#38; References","This project was created using the following software development sources and tools.",""],
...
["./uart-device-section-asa-emulatr.html","Introduction &#62; System Configuration &#62; UART Device Section","ASA Emulator Configuration Guide — [UART/...] Sections",""],
...
["./update-notice-introduction.html","Introduction &#62; Change Log","This page hosts the documentation change log.   Change/Notice/Description Date Author H&#38;M Authoring Software Attribution  20250918 T...",""],
["./usage-exampleconversionfunctions.html","Appendix &#62; Conversion Helper Functions &#62; Usage Example","// Example: CVTGF grain (G_float -&#62; IEEE single) // ASA: CVTGF converts VAX G to IEEE S; invalid on reserved operand; map to qNaN. void CVTGF_I...",""],
...
["./va---virtual-address-register.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; VA - Virtual Address Register","Holds the most recent virtual address used in a memory management (TLB) operation. Used by PALcode and OS for debug, TLB fills, and certain except...",""],
...
["./whami---ipr.html","Introduction &#62; Platform Architectures &#62; Alpha on ASA-EmulatR &#62; Alpha AXP Register Architecture (Modernized for Unified/128-bit Emulator Design) &#62; Internal Processor Register &#62; WHAMI - IPR","Returns the AlphaCPU’s::getCpuId() SMP as a synthetic &#8220;hardware ID&#8221;.  The CpuId() is unique and is assigned during SMP initialization.  ...",""],
