...
class ArithmeticInstruction : public IntegerInstruction
{
  public:
    ...
    bool RequiresComplexExceptionHandling() const override { return IsOverflowVariant(); }

    bool CanCauseTrap() const override { return IsOverflowVariant(); }
...
class AddqInstruction : public ArithmeticInstruction
{
  ...
  protected:
    quint64 PerformOperation(quint64 a, quint64 b) const override { return a + b; }
...
class S4AddqInstruction : public ArithmeticInstruction
{
  ...
  protected:
    quint64 PerformOperation(quint64 a, quint64 b) const override { return (a * 4) + b; }
...
class S8AddqInstruction : public ArithmeticInstruction
{
  ...
  protected:
    quint64 PerformOperation(quint64 a, quint64 b) const override { return (a * 8) + b; }
...
class CmpeqInstruction : public ComparisonInstruction
{
  ...
  protected:
    bool PerformComparison(quint64 a, quint64 b) const override { return a == b; }
};
...
class CmoveqInstruction : public ConditionalMoveInstruction
{
  ...
  protected:
    bool CheckCondition(quint64 value) const override { return value == 0; }
};
...
class CmovltInstruction : public ConditionalMoveInstruction
{
  ...
  protected:
    bool CheckCondition(quint64 value) const override { return static_cast<qint64>(value) < 0; }
};
...
class CmovlbcInstruction : public ConditionalMoveInstruction
{
  ...
  protected:
    bool CheckCondition(quint64 value) const override { return (value & 1) == 0; }
};
...
class CmovlbsInstruction : public ConditionalMoveInstruction
{
  ...
  protected:
    bool CheckCondition(quint64 value) const override { return (value & 1) == 1; }
};