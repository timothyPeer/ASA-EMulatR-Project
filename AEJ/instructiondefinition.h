...
public:
    ...
    InstructionDefinition(const QString& mnemonic, quint32 opcode, qint32 functionCode = -1,
        helpers_JIT::Format format = helpers_JIT::Format::FORMAT_OPERATE, helpers_JIT::Section section = helpers_JIT::Section::SECTION_OTHER,
    ...
    quint32 encoding = opcode << 26;  // Opcode in bits 31-26
        ...
        switch (format) {
        case helpers_JIT::Format::FORMAT_BRANCH:
        ...
        case helpers_JIT::Format::FORMAT_OPERATE:
        ...
        case helpers_JIT::Format::FORMAT_MEMORY:
            if (operandValues.size() >= 3) {
                quint32 ra = operandValues[0];
                quint32 disp = operandValues[1];
    ...
    // Format to string
    QString formatToString(helpers_JIT::Format fmt) const {
        switch (fmt) {
        case helpers_JIT::Format::FORMAT_OPERATE: return "Operate";
        case helpers_JIT::Format::FORMAT_BRANCH: return "Branch";
        case helpers_JIT::Format::FORMAT_MEMORY: return "Memory";
        case helpers_JIT::Format::FORMAT_SYSTEM: return "System";
        case helpers_JIT::Format::FORMAT_VECTOR: return "Vector";
        case helpers_JIT::Format::FORMAT_MEMORY_BARRIER: return "MemoryBarrier";
        default: return "Unknown";
        }
    }

    // Section to string
    QString sectionToString(helpers_JIT::Section sec) const {
        switch (sec) {
        case helpers_JIT::Section::SECTION_INTEGER: return "Integer";
        case helpers_JIT::Section::SECTION_FLOATING_POINT: return "FloatingPoint";
        case helpers_JIT::Section::SECTION_CONTROL: return "Control";
        case helpers_JIT::Section::SECTION_PAL: return "PAL";
        case helpers_JIT::Section::SECTION_VECTOR: return "Vector";
        case helpers_JIT::Section::SECTION_MEMORY: return "Memory";
        case helpers_JIT::Section::SECTION_OTHER: return "Other";
        default: return "Unknown";
        }
    }
    ...
    helpers_JIT::Format format = helpers_JIT::Format::FORMAT_OPERATE;
    helpers_JIT::Section section = helpers_JIT::Section::SECTION_OTHER;
...
private:
    ...
    void setFormatAndSectionFromClass(const QString& className) {
        ...
        if (className.contains("Branch", Qt::CaseInsensitive) ||
            ...
            format = helpers_JIT::Format::FORMAT_BRANCH;
        else if (className.contains("Memory", Qt::CaseInsensitive) ||
            mnemonic.startsWith("LD") || mnemonic.startsWith("ST"))
            format = helpers_JIT::Format::FORMAT_MEMORY;
        else if (className.contains("System", Qt::CaseInsensitive) ||
            mnemonic.startsWith("CALL_PAL"))
            format = helpers_JIT::Format::FORMAT_SYSTEM;
        else if (className.contains("Vector", Qt::CaseInsensitive) ||
            mnemonic.startsWith("V"))
            format = helpers_JIT::Format::FORMAT_VECTOR;
        else if (mnemonic.contains("MB"))
            format = helpers_JIT::Format::FORMAT_MEMORY_BARRIER;
    }
    ...
    void guessFormatAndSection() {
        ...
        if (mnemonic.startsWith("B") && !mnemonic.startsWith("BI")) {
            ...
            format = helpers_JIT::Format::FORMAT_OPERATE;
            section = helpers_JIT::Section::SECTION_FLOATING_POINT;
        }
        else {
